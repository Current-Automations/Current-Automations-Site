...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "We start every engagement with a free walkthrough, a 30-minute call where we map exactly where your business is losing time and money. From there, we recommend the one or two systems with the highest impact. Speed to Lead is the most common starting point, but it is not always the first fix.",
  },
  {
