...
const clauseIndex = [
  { code: "01", title: "Who We Are" },
  { code: "02", title: "Scope of This Policy" },
  { code: "03", title: "Information We Collect" },
  { code: "04", title: "How We Use Your Information" },
  { code: "05", title: "Legal Basis for Processing" },
  { code: "06", title: "Commercial Electronic Messages and CASL" },
  { code: "07", title: "How We Share Your Information" },
  { code: "08", title: "Data Retention" },
  { code: "09", title: "Security" },
  { code: "10", title: "Your Rights Under PIPEDA" },
  { code: "11", title: "Cookies and Website Tracking" },
  { code: "12", title: "Third-Party Links" },
  { code: "13", title: "Children's Privacy" },
  { code: "14", title: "Changes to This Policy" },
  { code: "15", title: "Contact Us" },
];
      ...
      <section className={`${jobsheet.root} ${jobsheet.paperTexture} relative py-16 sm:py-20`}>
        <div className="container-shell relative">
          <div className="grid gap-8 lg:grid-cols-[13rem_minmax(0,1fr)] lg:items-start">
            ...
            <nav
              aria-label="Privacy policy clauses"
            ...
            <div className={`${jobsheet.ticket} overflow-hidden p-0`}>
                  ...
                  <p>
                    ...
                    our website and services. We can be reached at {siteContacts.general} or
                    {siteContact.phoneDisplay}.
                  </p>
                </JobSheetLegalClause>

                              <JobSheetLegalClause id="clause-02" code="02" title="Scope of This Policy">
                  <p>
                  ...
                  <p>
                    ...
                    Google Calendar. Each of those providers operates under its own privacy policy.
                              ...
                              <JobSheetLegalClause id="clause-03" code="03" title="Information We Collect">
                  <p>
                  ...
                  <p>
                    ...
                    information to identify individual visitors.
                              ...
                              <JobSheetLegalClause id="clause-04" code="04" title="How We Use Your Information">
                  <p>
                  ...
                  <p>
                    ...
                    without your knowledge and consent.
                              ...
                              <JobSheetLegalClause id="clause-05" code="05" title="Legal Basis for Processing">
                  <p>
                  ...
                  <p>
                    ...
                    of consent may affect our ability to deliver certain services.
                              ...
                              <JobSheetLegalClause id="clause-06" code="06" title="Commercial Electronic Messages and CASL">
                  <p>
                  ...
                  <p>
                    ...
                    CASL compliance.
                              ...
                              <JobSheetLegalClause id="clause-07" code="07" title="How We Share Your Information">
                  ...
                  <p>
                    ...
                    different privacy policy.
                              ...
                              <JobSheetLegalClause id="clause-08" code="08" title="Data Retention">
                  <p>
                  ...
                  <p>
                    ...
                    will age out under our normal backup rotation cycles.
                              ...
                              <JobSheetLegalClause id="clause-09" code="09" title="Security">
                  <p>
                  ...
                  <p>
                    ...
                    assess and address the incident.
                              ...
                              <JobSheetLegalClause id="clause-10" code="10" title="Your Rights Under PIPEDA">
                  <p>
                  ...
                  <p>
                    To exercise any of these rights, contact us at {siteContacts.general} with the
                  ...
                  <p>
                    ...
                    cookies for advertising or cross-site tracking purposes.
                              ...
                              <JobSheetLegalClause id="clause-12" code="12" title="Third-Party Links">
                  <p>
                    ...
                    practices of third-party websites.
                              ...
                              <JobSheetLegalClause id="clause-13" code="13" title="Children's Privacy">
                  <p>
                    ...
                    contact us immediately at {siteContacts.general} and we will delete it
                    promptly.
                  </p>
                </JobSheetLegalClause>

                              <JobSheetLegalClause id="clause-14" code="14" title="Changes to This Policy">
                  <p>
                  ...
                  <p>
                    ...
                    privacy practices, contact us at {siteContacts.general} or {siteContact.phoneDisplay} or
